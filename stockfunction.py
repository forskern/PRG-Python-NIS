...
class StockFunction:
    ...
    def populate_stock(self, stocklist):
        self.product_list = stocklist
    ...
    def func_update(self, code, quantity, price):
        ...
        if code in self.product_list:
            ...
            return -1                                                       # Return error value
        if data.getvalue("update_stock") == 1:
            func_update()
...
print("<body>")
if func_update:
    print("<h1>", func_update)
else:
    print("<h1>Ingen argumenter</h1>")
print("<a href=\"shoppingcart.html\">Back</a>")
print("</body>")
print("</html>")
print(stock)
